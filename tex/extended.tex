...
A consequence of the maximality property is that if an inconsistency predicate
is induced by an algebraic closure operator, the maximal equiconsistent
extensions provided by Theorem~\ref{thm:max-inc-countable} are automatically
closed under the given operator. For instance, maximal equiconsistent

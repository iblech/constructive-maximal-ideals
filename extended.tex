...
%
%what about uncountable? expl. of Sect. 4
%we can also exploit a relativity phenomenon of
%mathematical logic in order to drop, with some caveats, the assumption that the ring~$A$ is countable.
%

...
\usepackage{amssymb,amsmath,mathtools,proof,xcolor}
...
The objective of this section is to give a purely syntactical account focusing
...
- cite:
  \cite[pp.~36f.]{joyal-tierney:grothendieck};~\cite{blechschmidt:generalized-spaces,johnstone:point,vickers:continuity,vickers:locales-toposes};~\cite{maietti:au,vickers:sketches,crosilla:predicativity}. Mention
  Löwenheim--Skolem.
...
property of being a field. Can the techniques of this paper be used to
construct a minimal prime ideal, or classically equivalently a maximal prime
...
Given any sequence~$\ppp_0,\ppp_1,\ldots$ of prime filters of~$A$, we can
...
\end{align*}
(A \emph{chain} is a subset such that for any two members~$\ppp$ and~$\ppp'$,
...
in the forcing extension where~$P$ was forced to be countable. However,

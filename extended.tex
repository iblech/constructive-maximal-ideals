...
let~$\Inc{U}$ denote that~$U = M$. Then~$O$ is an inconsistency predicate if and
...
assume~$\Inc{A_{n+1}}$. Since~$A_{n+1} \subseteq A_n \cup \{x_n\}$, we have~$\Inc{A_n
\cup \{ x_n \}}$ by monotonicity. Hence~$A_{n+1} = A_n \cup \{ x_n \,|\, \Inc{A_0}

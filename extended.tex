...
\begin{quote}\it The dynamical method is equivalent to
\begin{enumerate}
...
by its \emph{notion of forcing}. This is a poset~$(L,{\preceq})$ equipped with a
...
ordering: $\mathcal{A} \preceq \mathcal{B}$ iff~$\mathcal{A} \vdash b$ for every

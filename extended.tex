...
see~\cite[Sections~6.7,~6.8]{borceux:handbook3}.\end{proof}
...
which satisfy this condition. There is a further condition which in many cases
of interest is even strong, a wellfoundedness attributed to
...
earlier flavors of Noetherianity had to overcome, the clean proof for the
inductive condition~\cite[Corollary~16]{coquand-persson:groebner} has an almost magical
quality to it.

...
\[
  \Cov(\sigma) \defeq \{ \emptyset \,|\, O(\sigma) \} \cup
    \{ \{ \sigma \vee \tau \} \cup \{ \sigma \vee \tau' \,|\, \tau' \in
    \overline{\tau} \} \,|\, \tau \in P \},
\]
...
\subsubsection{The connection to dynamical algebra}
...
\begin{proposition}With the terminology of Proposition~\ref{prop:jac}, for
...
% xxx: clarify that only bounded first-order statements are meant

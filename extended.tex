...
xxx cite roitman:uses
"mainstream mathematics (defined as: the mathematics most mathematicians think
doesn't use set theory) is beginning to see results using modern set theoretic
techniques."

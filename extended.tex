...
%The second topic of this paper is the general toolbox of dynamical
%algebra~\cite[Section~XV.6]{lombardi-quitte:constructive-algebra},~\cite{coquand-lombardi-roy:dynamicalmethod},~\cite{yengui:constructive},~\cite{duval:about},~\cite{neuwirth:lorenzen}. Since its multiple
...
%
%General idea of dyn. alg.
%
%Why only $1 = 0$?
%
%Reification of dyn. alg.: apply constr. to gen. surj.

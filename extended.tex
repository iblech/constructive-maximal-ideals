...
\[\Cov(\aaa) \defeq
  \Bigl\{ \{ \aaa + (x) \} \cup \{ \aaa + (u) \,|\, u,v \in A, u + vx = 1 \}
  \,\Big|\, x \in A \Bigr\}
  \cup
...
case, we decree
\[ \Cov([\varphi]) \defeq \bigl\{ \{ \psi_1,\ldots,\psi_n \} \,|\,
...
\[ \Cov([\varphi]) \defeq \bigl\{ M \in P({\downarrow}[\varphi]) \,\big|\,
  ...
  \bigr\}. \]
An element~$[\varphi] \in L$ is read as partial knowledge about a (perhaps
fictitious) model of~$\TT$. For instance, if~$\TT$ is the theory of strong

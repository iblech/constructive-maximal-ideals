...
XXX add here:
surjective matrix with more rows than columns can exist only over trivial ring
(this test case really needs the maximal ideal property, not merely the prime
ideal property). Also briefly comment on Suslin's lemma.

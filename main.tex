...
We indicate here how the dynamic approach is intimately connected with the
...
in Remark~\ref{rem:suslin} can upgrade the maximal ideal from one only
...
Unfolding the construction of Section~\ref{sect:constr} and the proof of Joyal
